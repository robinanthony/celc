...
def get_tasks():
    # database = psycopg2.connect(dbname="gis", user="docker", password="docker", host="postgresql", port="5432")
    database = psycopg2.connect(dbname="gis", user="docker", password="docker", host="localhost", port="5432")
    res = []
